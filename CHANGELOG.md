...
Historie kontrol, ověřování zdrojů a změn obsahu jednotlivých sekcí
webu pecky.online. Nejnovější záznamy nahoře. Aktuální stav
kontroly/změny u každé sekce je v [`README.md`](README.md) →
„Stav sekcí".
