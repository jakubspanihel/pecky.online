...
|---|---|---|---|---|
| [Volby](volby/README.md) | odvozená | — | 9. 9. 2026 | blok „Volební účast stoupá": zrušeno rozbalovací tlačítko, graf je trvale viditelný; graf prohozen s vysvětlujícím odstavcem (teď nad ním, ne pod), pod nadpis doplněna věta „K volebním urnám přichází pouze přibližně polovina oprávněných obyvatel." |
