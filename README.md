...
|---|---|---|---|---|
| [Volby](volby/README.md) | odvozená | — | 9. 9. 2026 | blok „Volební účast stoupá" přesunut sem ze záložky Rozbor na `/volby/2022/` (pod seznam „Volební ročníky") — srovnává napříč ročníky, patřil na společný rozcestník, ne do jednoho ročníku; SVG graf beze změny (bordó linka Pečky, šedá průměr ČR, 2014→2022) |
| [Volby 2022](volby/2022/README.md) | uzavřené | — | 9. 9. 2026 | blok „Volební účast stoupá" (SVG graf) přesunut ze záložky Rozbor na rozcestník `/volby/` — v panelu Volby 2022 už není, viz `volby/README.md` |
