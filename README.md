...
|---|---|---|---|---|
| [Volby 2022](volby/2022/README.md) | uzavřené | — | 8. 9. 2026 | blok „Volební účast stoupá" (Rozbor): tabulka nahrazena ručně psaným SVG liniovým grafem (bordó širší linka Pečky, šedá průměr ČR, 2014→2022 zleva doprava, graf roztažen na šířku) — žádná JS knihovna, viz `volby/2022/README.md` |
