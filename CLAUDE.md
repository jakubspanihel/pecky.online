...
připojené složky, `preview_start`) jsou v samostatném
[`TROUBLESHOOTING.md`](TROUBLESHOOTING.md) — nemísit je sem, jsou
specifické pro konkrétní stroj/relaci, ne trvalé konvence k datům.
